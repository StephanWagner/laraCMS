...
return [
    ...
    'deleteModal' => [
        ...
        'textForceDelete' => '<b class="-error-text"><span class="icon -text-icon">warning</span> Achtung:</b> Der Eintrag wird dauerhaft gelöscht und kann nicht wiederhergestellt werden.',
        'textForceDeleteBulk' => '<b class="-error-text"><span class="icon -text-icon">warning</span> Achtung:</b> Alle ausgewählten Einträge werden dauerhaft gelöscht und können nicht wiederhergestellt werden.',
