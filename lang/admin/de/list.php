...
return [
    ...
    'actionLabel' => [
        ...
        'reorder-to-top' => 'An den Anfang',
        'reorder-to-bottom' => 'An das Ende',
    ...
    'deleteModal' => [
        ...
        'textForceDelete' => '<b class="-error-text"><span class="icon -error-warning-icon">warning</span>Achtung:</b> Der Eintrag wird dauerhaft gelöscht und kann nicht wiederhergestellt werden.',
        'textForceDeleteBulk' => '<b class="-error-text"><span class="icon -error-warning-icon">warning</span>Achtung:</b> Alle ausgewählten Einträge werden dauerhaft gelöscht und können nicht wiederhergestellt werden.',
